...
# VOLUME declaration removed for Railway deploys: Railway's build system
# rejects any Dockerfile containing a VOLUME instruction and requires using
# a Railway Volume mounted at the same path instead (already configured).
